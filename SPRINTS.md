...
- Role navigation has been streamlined: the shared top bar now exposes each role's primary routes with a visible horizontal-overflow affordance, signed-in language selection lives in account settings, and landing/login language controls are compact and URL-based.
